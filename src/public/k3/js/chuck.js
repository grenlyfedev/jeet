...
function GetMyEmerdList(list_orders) {
    ...
    let result = list_orders.map((list_order) => {
        let arrx = String(list_order.result).split('');
        let resultData = ``;
        let totalx = 0;
        
        for (let i = 0; i < arrx.length; i++) {
            totalx += Number(arrx[i]);
            resultData += `
                <div data-v-03b808c2="" class="li img${arrx[i]}"></div>
            `;
        }
        let join = '';
            ...
            <div data-v-03b808c2="">
                <div data-v-03b808c2="" class="item c-row">
                    <div data-v-03b808c2="" class="c-row c-row-between c-row-middle info">
                        <div data-v-03b808c2="">
                        <div style="color: #efd58c;" data-v-03b808c2="" class="issueName">
                                ${list_order.stage}
                                <!---->
                                <span data-v-03b808c2="" class="state ${(list_order.status == 1) ? 'green' : 'red'} ${(list_order.status == 0) ? 'd-none' : ''}">${(list_order.status == 1) ? 'Success' : 'Fail'}</span>
                            </div>
                            <div style="color: #858895;" data-v-03b808c2="" class="tiem">${timerJoin(list_order.time)}</div>
                        </div>
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="goItem c-row c-tc c-row-between c-row-middle" style="display: ${(list_order.status == 0) ? 'none' : ''};">
                    ${resultData}
                  </div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
